...
const FighterSliderpagesec = () => {
  return (
        <>
        <HeaderMain/>
        <div className='fightersliderpage fightersliderpagesec'>
                    ...
                    <div className='col-md-12'>
                            ...
                            <div className='fighterslider-profile'>
                                    ...
                                    <div className='fighterslider-profile-detail'>
                                        ...
                                        <div className='f-s-name'>
                                        Jack Dorsee
                                        </div> 
                                                <div className='profile-button-fighter'>
                                            <a href='#' className='edit'>Edit Profile</a>
                                            <a href='#' className='edit report'>Report</a>


                                                </div>
                                        </div>
                                        <div className='f-s-title'>
                                        UFC_Fighter
                                            </div> 
    
                                            <div className='f-s-desc'>
                                            No fear. No mercy. Just fists, fire, and the will to dominate.
                                                </div> 
                                            <div className='for-mobile-fighter-sec'>
                                            <a href='#' className='edit edit-mobile'>Edit Profile</a>
                                            <a href='#' className='edit edit-mobile report-mb'>Report</a>
                                            </div>
...
export default FighterSliderpagesec